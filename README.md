...
The composite policy evaluates frozen provider-observation snapshots through a pure candidate selector; provider I/O, metrics, and mutable counters remain outside that decision core. See [`docs/architecture.md`](docs/architecture.md#components-and-boundaries) for the boundary and [`docs/adr/0008-adaptive-routing-strategies.md`](docs/adr/0008-adaptive-routing-strategies.md) for the trade-off.
